  ...
  <div>
    <div v-show="isLogin == false" class="aaa">
      <el-button type="primary" color="" @click="toLogin()" v-show="isLogin == false"
        style="margin-left:40%;margin-top:20%;font-size:20px;height:80px;width: 180px;">获取最新学生信息</el-button>
    </div>
    <div v-show="isLogin">
      <div style="margin-left: 30px;margin-top: 30px;font-size: 20px;">学生信息管理</div>
    ...
    <div v-show="isLogin">
      <div>
        <el-table :data="tableData.slice((currentPage - 1) * pagesize, currentPage * pagesize)" border
          ...
          <el-table-column prop="major" label="专业" width="90" align="center" />
          <el-table-column prop="classinfo" label="班级" width="120" align="center" />
          <el-table-column prop="studentNo" label="学号" width="110" align="center" />
          <el-table-column prop="studentName" label="学生姓名" width="80" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" title="添加/更改">
      <el-form :model="newOne">
        ...
        <el-form-item label="专业" :label-width="formLabelWidth">
          <el-input v-model="newOne.major" autocomplete="off" />
        </el-form-item>
        <el-form-item label="班级" :label-width="formLabelWidth">
          <el-input v-model="newOne.classinfo" autocomplete="off" />
        </el-form-item>
        <el-form-item label="学号" :label-width="formLabelWidth">
          <el-input v-model="newOne.studentNo" autocomplete="off" />
        </el-form-item>
        <el-form-item label="学生姓名" :label-width="formLabelWidth">
          <el-input v-model="newOne.studentName" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog v-model="updateDialogFormVisible" title="添加/更改">
      <el-form :model="newOne">
        ...
        <el-form-item label="专业" :label-width="formLabelWidth">
          <el-input v-model="editOne.major" autocomplete="off" />
        </el-form-item>
        <el-form-item label="班级" :label-width="formLabelWidth">
          <el-input v-model="editOne.classinfo" autocomplete="off" />
        </el-form-item>
        <el-form-item label="学号" :label-width="formLabelWidth">
          <el-input v-model="editOne.studentNo" autocomplete="off" />
        </el-form-item>
        <el-form-item label="学生姓名" :label-width="formLabelWidth">
          <el-input v-model="editOne.studentName" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
